<template>
  <div class="container mx-auto xl:px-20 my-8">
    <h1 class="text-4xl font-bold text-center text-blue-700">Edit</h1>
    <div class="mt-8 max-w-lg mx-auto bg-gray-100 border border-gray-300 rounded-lg shadow-lg">
      <div v-if="isLoading" class="text-center py-6">
        <Spinner />
      </div>
      <div v-else>
        <form class="p-6 space-y-6" @submit.prevent="editBarang">
          <div>
          ...
          <div>
            ...
            <input type="text" id="kode" v-model="barang.kode"
              class="bg-white border-2 border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 shadow-inner block w-full px-4 py-2">
          ...
          <div class="flex justify-between">
            ...
            <button type="submit"
              class="bg-blue-700 hover:bg-blue-800 text-white rounded-lg px-5 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-500">Simpan</button>
          </div>
        </form>
      </div>
    </div>
